...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     &  sum_sfcsublim(nx_max,ny_max)
      ...
      real swe_change_tmp,swe_change
...
c   Utau.
     ...
     &      gravity,z_0,h_star,h_const,vegtype,vegsnowd_xy,snow_d,
...
c Solve for the saltation flux.
     ...
     &        ro_air,gravity,vegtype,vegsnowd_xy,snow_d,
...
c SALTATION
     ...
     &  index_vn,index_vs,ro_snow,dt,vegtype,
     &  vegsnowd_xy,snow_d,soft_snow_d)
