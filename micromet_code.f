...
c     print *,'WORKING ON MODEL TIME = ', iyear,imonth,iday,xhour
      write (*,150) iyear,imonth,iday,xhour
  150 format('                          WORKING ON MODEL TIME =',
     &  i5,2i4,f6.1)
...
c       print *,'   solving for wind speed and direction'
     ...
     &    barnes_lg_domain,n_stns_used,k_stn)
